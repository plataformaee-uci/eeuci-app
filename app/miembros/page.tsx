          ...
          <>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-white/10 border border-white/20 px-4 py-2.5 text-sm font-semibold text-white hover:bg-white/15 transition"
              >
                <svg
                  className="w-4 h-4"
                  viewBox="0 0 24 24"
